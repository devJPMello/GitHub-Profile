...
Uma aplicação web desenvolvida com React + TypeScript que permite buscar e visualizar perfis públicos do GitHub de forma rápida e elegante.
...
1. ** Clone o repositório**
	```bash
	git clone https://github.com/devJPMello/GitHub-Profile.git
